...
SECRET_KEY = "django-insecure-cu%c*$9rpmhg!hexprzqou&shh54h4b@1g(gzu0&$g6wi2c_f+"
...
if os.getenv("DATABASE_ENGINE", "postgres").lower() == "sqlite":
    DATABASES = {
        "default": {
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "aeromiles"),
